...
"<(sed -n '1,29p' tiempos_procedural_pulqui.txt)" using 1:2 title 'Tiempos procedural pulqui' w lp ls 2, \
"tiempos_openmp_4t.txt" using 1:2 title 'Tiempos openmp local (4T)' w lp ls 3, \
"tiempos_openmp_8t.txt" using 1:2 title 'Tiempos openmp local (8T)' w lp ls 4, \
"tiempos_openmp_16t.txt" using 1:2 title 'Tiempos openmp local (16T)' w lp ls 5, \
"tiempos_openmp_pulqui_4t.txt" using 1:2 title 'Tiempos openmp pulqui (4T)' w lp ls 6, \
"tiempos_openmp_pulqui_8t.txt" using 1:2 title 'Tiempos openmp pulqui (8T)' w lp ls 7, \
"tiempos_openmp_pulqui_16t.txt" using 1:2 title 'Tiempos openmp pulqui (16T)' w lp ls 8